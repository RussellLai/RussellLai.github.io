class Scatterplot {
    ...
    updateVis() {
      ...
      document.getElementById(vis.config.parentElement.substring(1)).clientWidth;

      console.log("The current container width is:", vis.config.containerWidth);

      // Calculate inner chart size. Margin specifies the space around the actual chart.
      // TODO modify the line to set the config.height
      ...
      // TODO tweak this code to work within our vis object (how do we reference THIS VIS's svg?)
